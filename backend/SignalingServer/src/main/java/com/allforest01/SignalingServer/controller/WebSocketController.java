package com.allforest01.SignalingServer.controller;

import com.allforest01.SignalingServer.service.SignalingService;
...
public class WebSocketController {
    ...
    public void registerCSR(String csrMessage) {
        ...
        signalingService.registerCSR(csrID);
    ...
    public void callCSR(String callMessage) {
        ...
        String csrID = signalingService.getNextAvailableCSR();
        if (csrID != null) {
